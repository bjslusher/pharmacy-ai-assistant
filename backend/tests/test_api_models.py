...
# Import real models from main without starting lifespan RAG if possible.
# main imports rag_service at module level; tests that only need models
# can redefine mirrors — here we import ChatRequest after patching heavy deps.
...
class TestChatRequestValidation:
    ...
    def test_custom_user_and_session(self):
